			...
			$.ajax({
				...
				success: function(msg){
					if("vcodeError" == msg){
					    ...
					    sessionStorage.setItem("type",msg);
...
<title>登录|智选课系统</title>
<meta name="keywords" content="选课系统">
</head>
<body>

<div class="header" style="padding: 0;background-color: #10a3d4">
...
<div class="loginWraper" >
  <div id="loginform" class="loginBox" style="height: 380px;background-color: #ccccccde">
