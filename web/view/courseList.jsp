	...
	$(function() {
	  ...
	  //编辑课程信息
	    ...
	    $("#delete").click(function(){
			...
			var selectVal = $("#dataList").datagrid("getSelected").selectedNum;
			if(selectVal >= 15){
				$.messager.alert("消息提醒", "该班级人数已超过15人!", "warning");
				return;
			}
...
<body>
	...
	<div id="toolbar">
		...
		<div style="margin-top: 3px;display: flex">
			...
			<div style="width: 40%;margin-left: 20px" class="input-group input-group mb-3">
			...
			<span style="font-size: 18px;margin-left: 20px">授课老师：</span><input id="teacherList" class="easyui-textbox" name="clazz" />
