...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'name',title:'班级名称',width:260},
	    ...
	    //设置工具类按钮
	    $("#add").click(function(){
			if(sessionStorage.getItem("type") == 2 || sessionStorage.getItem("type") == 3){
				$.messager.alert("消息提醒","此操作你无权限!","warning");
				return;
...
<body>
	...
	<div id="toolbar">
		<div style="float: left;"><a id="add" href="javascript:;" class="btn btn-success" data-options="iconCls:'icon-add',plain:true">
			...
			添加</a></div>
		<div style="float: left; margin-right: 10px;margin-left: 10px"><a id="edit-btn" href="javascript:;" class="btn btn-info" data-options="iconCls:'icon-edit',plain:true">
			<i class="bi bi-pencil-square"></i>
			修改</a></div>
		<div style="float: left; margin-right: 10px;"><a id="delete" href="javascript:;" class="btn btn-danger" data-options="iconCls:'icon-some-delete',plain:true">

			<i class="bi bi-trash"></i>
			删除</a></div>
		<div style="margin-top: 3px;display: flex">
			<div class="input-group input-group mb-3" style="width: 45%">
				<div class="input-group-prepend">
					<span class="input-group-text" id="inputGroup-sizing-sm">班级名称：</span>
				</div>
				<input id="clazzName"  class="form-control" type="text"
					   name="clazzName" />
