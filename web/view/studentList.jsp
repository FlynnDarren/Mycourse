        ...
        $(function () {
            ...
            $('#dataList').datagrid({
                ...
                columns: [[
                    ...
                    {field: 'id', title: '学号', width: 150, sortable: true},
...
<body>
<!-- 学生列表 -->
<table id="dataList" cellspacing="5" cellpadding="0">
...
<div id="toolbar">
    <c:if test="${userType == 1 || userType == 3}">
        <div style="float: left;">
            <a id="add" href="javascript:;" class="btn btn-success" data-options="iconCls:'icon-add',plain:true">
    ...
    <div style="float: left;">
        <a id="edit" href="javascript:;" class="btn btn-info"
    ...
    <c:if test="${userType == 1 || userType == 3}">
        <div style="float: left;">
            <a id="delete" href="javascript:;" class="btn btn-danger"
               data-options="iconCls:'icon-some-delete',plain:true">
                <i class="bi bi-trash"></i>
                删除</a>
        </div>
    </c:if>
    <div style="float: left;margin-top:4px;margin-left: 30px" class="datagrid-btn-separator">
<%--        <input--%>
<%--            id="search_student_name" class="easyui-textbox" name="search_student_name"/>--%>
        <div class="input-group input-group mb-3">
            <div class="input-group-prepend">
                <span class="input-group-text" id="inputGroup-sizing-sm">姓名:</span>
            </div>
            <input id="search_student_name"  class="form-control" type="text"
                   name="search_student_name" />

        </div>
    </div>
    <div style="margin-left: 30px;margin-top:4px;display: flex">
        <span style="margin-left: 20px;font-size: 16px">班级：</span>
        <input id="clazzList" class="easyui-textbox" name="clazz"/>



        <a id="search-btn" style="margin-left: 20px" href="javascript:;" class="btn btn-primary"
...
<div id="addDialog" style="padding: 10px">
    ...
    <form id="addForm" method="post">
        <table cellpadding="8">
            ...
            <tr>
                <td>学号:</td>
                <td><input id="num_name" style="width: 200px; height: 30px;" class="easyui-textbox" type="text"
                           name="num_name" data-options="required:true, missingMessage:'请填写学号'"/></td>
            </tr>
        ...
        <table cellpadding="8">
            <tr>
                ...
                <td>
                        ...
                        <input id="edit_name"  class="easyui-combobox" type="text"
                               name="name" data-options="required:true, missingMessage:'请填写姓名'"/>
