							...
							$.ajax({
								...
								success: function(msg){
									if(msg == "success"){
										...
										return;
									}else if(msg == "courseLimit"){
										$.messager.alert("消息提醒","每位学生最多只能选修三门课程!","warning");
									}
									else{
...
<body>
	...
	<div id="toolbar">
		...
		<div style="margin-top: 3px;">
			...
			<span style="font-size: 18px">学生：</span><input id="studentList" class="easyui-textbox" name="studentList" />
			<span style="font-size: 18px">课程：</span><input id="courseList" class="easyui-textbox" name="courseList" />
			<a id="search-btn" href="javascript:;" class="btn btn-primary" data-options="iconCls:'icon-search',plain:true">
