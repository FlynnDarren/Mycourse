	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'sn',title:'工号',width:220, sortable: true},
...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left;margin-left: 10px"><a id="edit" href="javascript:;" class="btn btn-info" data-options="iconCls:'icon-edit',plain:true">
		...
		<div style="float: left;margin-top:4px;" class="datagrid-btn-separator" >
			...
			<div class="input-group input-group mb-3" style="margin-left: 10px">
		...
		<div style="margin-left: 30px;margin-top:4px;display: flex;" >
			...
			<span style="margin-left: 20px;font-size: 15px">班级：</span>
